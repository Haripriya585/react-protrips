        ...
        return (
            <div>
                ...
                <form onSubmit={this.handleSubmit} className="form">
                    <input type="date" className="trip-start" ref="date" min="1999-01-01" max="2040-12-31" /><br></br>
                    <input type="text" placeholder="Enter Place" className="place" ref="place" /><br></br>
